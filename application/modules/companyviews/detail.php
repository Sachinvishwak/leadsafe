								...
								<div class="col-sm-12">
									...
									<div class="row">
										<div class="col-sm-12 padding-left-1">
											...
											<h3 class="margin-top-0">Crew Member Name  : <a href="javascript:void(0);"> <?= $task['name']; ?> </a></h3>
										...
										<?php
										    ...
										    $mediapath = base_url('uploads/crew/').$task['licence'];
                                        ...
                                        <div>
                                        <object style="width:100%; overflow:hidden;" src="<?php echo base_url('uploads/crew/').$task['licence']; ?>"><iframe style="width:450px;height:400px;" src="https://docs.google.com/viewer?url=<?php echo base_url('uploads/crew/').$task['licence']; ?>&embedded=true"></iframe></object>
                                        </div>
										...
										$mediapath = base_url('uploads/crew/').$task['insurence_certificate'];
                                        ...
                                        { ?>
                                        <div>
                                        <object style="width:100%; overflow:hidden;" src="<?php echo base_url('uploads/crew/').$task['insurence_certificate']; ?>"><iframe style="width:450px;height:400px;" src="https://docs.google.com/viewer?url=<?php echo base_url('uploads/crew/').$task['insurence_certificate']; ?>&embedded=true"></iframe></object>
                                        </div>
