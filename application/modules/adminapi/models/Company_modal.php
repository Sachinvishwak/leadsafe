...
class Company_modal extends CI_Model {
    ...
    var $table          = 'company';
    var $column_order   = array('company_id','name','email','phone_number'); //set column field database for datatable orderable
    ...
    var $column_search = array('name','email'); //set column field database for datatable searchable 
    var $order         = array('company_id' => 'desc');  // default order
    var $where         = array();
    var $group_by      = 'company_id'; 
