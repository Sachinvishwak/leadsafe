				...
				<div>
					...
					<div class="widget-body padding">
						<div class="table-responsive">
							<table  class="table table-striped table-bordered table-hover dataTables-example-list" width="100%" data-list-url = "adminapi/company/list" data-id ="" data-no-record-found = "">
								<thead>			                
									<tr>
