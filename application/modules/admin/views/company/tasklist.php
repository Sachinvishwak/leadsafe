				...
				<div>
					...
					<div class="widget-body padding">
						<div class="table-responsive">
							<table  class="table table-striped table-bordered table-hover dataTables-example-list" width="100%" data-list-url = "adminapi/Company/tasklist" data-id ="" data-no-record-found = "">
								<thead>			                
									<tr>
										...
										<th data-hide="phone,tablet">Import</th>
									</tr>
								</thead>
								<tbody>			
								</tbody>
