...
<script src="<?php echo $backend_assets.'js/spartan-multi-image-picker.js'; ?>"></script>
<section id="widget-grid" class="">
  <!-- row -->
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
      <div class="well no-padding">
        <form action="company/add" id="companyAddUpdate" class="smart-form" novalidate="novalidate" autocomplete="off" enctype="multipart/form-data" method="post">
  ...
  var fsize = f.size||f.fileSize;
   ...
   $(document).on('change', '#insurence_certificate_media', function(){
    ...
    $(document).on('click', '#invitecompany', function(){
        ...
        $.ajax({
            url:"<?php echo site_url('company/companyapi/invitecompany') ?>",
            method:"POST",
