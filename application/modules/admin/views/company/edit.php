	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
			<div class="well no-padding">
				<form action="company/edit" id="taskAddUpdate" class="smart-form" novalidate="novalidate" autocomplete="off" enctype="multipart/form-data" method="post">
					
					<fieldset>
						<div class="row">
								<input type="hidden" name="id" value="<?= encoding(@$company['company_id']); ?>">
						...
						<div class="row">
							<section class="col col-md-12">
								...
								<label class="input">
									<input class="form-control" type="text" readonly name="email" placeholder="Company Email" maxlength="100" size="100"  value="<?= @$company['email']; ?>" >
    						    </label>
								</label>
							</section>				
						</div>
						...
						<div class="row">
							<section class="col col-md-12">
								<label class="label">Fax Number<span style="font-size: 11px;margin-left: 6px;color: #574f45;">(Not required)</span></label>
								<label class="input">
        						<input class="form-control" type="text" name="fax_number" value="<?= @$company['fax_number']; ?>" class="number-only" placeholder="Fax Number" data-mask="9999999999" maxlength="10"> 
								</label>
							</section>				
						</div>
