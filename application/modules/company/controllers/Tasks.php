...
class Tasks extends Common_Back_Controller {
    ...
    public function edit() { 
        ...
        $invite_people_data_array = array();
        ...
        foreach($invite_people_data as $value)
        {
            if($value->role == 'leadcontractor' || $value->role == 'subcontractor')
            {
                ...
                {
                    $value->user_name = $user_data[0]->owner_first_name;
                    $value->user_email = $user_data[0]->email; 
                    array_push($invite_people_data_array,$value);
                }else{
                    $value->user_name = "";
                    $value->user_email = "";
                }
        ...
        $invite_people_data = $invite_people_data_array;
        $data['invite_people_data']      = $invite_people_data;
        
        // echo "<pre>";
        // print_r($invite_people_data);
        // die;
