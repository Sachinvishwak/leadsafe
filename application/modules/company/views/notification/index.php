				...
				<div>
					...
					<div class="widget-body padding">
						<div class="table-responsive">
							<table  class="table table-striped table-bordered table-hover dataTables-example-list" width="100%" data-list-url = "company/Notificationapi/list" data-id ="<?php echo $_SESSION['company_sess']['id']; ?>" data-no-record-found = "">
								<thead>			                
									<tr>
