	...
	<div class="col-sm-12">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/contractor'); ?>">Contactor</a></li>
            <li class="breadcrumb-item active" aria-current="page"><?= $task['owner_first_name']; ?></li>
          </ol>
        </nav>
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="row">
									    ...
									    <div class="col-sm-2">
										    <p id="clientfont">Company Name</p>
										</div>
										<div class="col-sm-10">
										...
										<div class="col-sm-2">
										    <p id="clientfont">Contractor  Name</p>
										</div>
										<div class="col-sm-10">
										    <p>: <?= $task['owner_first_name']; ?></p>
										</div>
										
										<!--<div class="col-sm-2">-->
										<!--    <p id="clientfont">Owner Last Name</p>-->
										<!--</div>-->
										<!--<div class="col-sm-10">-->
										<!--    <p>: <?= $task['owner_last_name']; ?></p>-->
										<!--</div>-->
										...
										<div class="col-sm-2">
										    <p id="clientfont">Role</p>
										</div>
										<div class="col-sm-10">
										    <p>: <?php
											    if($task['is_role'] == 1)
											    {
											        echo 'Lead Contractor';
											    }else{
											        echo 'Sub Contractor';
											    }
											?></p>
										...
										<input type="hidden" id="task_id_id" name="task_id_id" value="<?= encoding($company_id) ?>"/>
											<!--<h3 class="margin-top-0">Company Name   <a class="fontset" style="margin-left: 68px;" href="javascript:void(0);"><label class="text-capitalize">  :  <?= $task['company_name']; ?></label> </a></h3>-->

           <!--                             <p class="text-capitalize">Owner First Name<label class="fontset" style="margin-left: 59px;" >  :    <?= $task['owner_first_name']; ?></label></p>-->
           <!--                             <p class="text-capitalize">Owner Last Name<label class="fontset" style="margin-left: 60px;" class="text-capitalize">  :     <?= $task['owner_last_name']; ?></label></p>-->
                                            
											<!--<p class="text-capitalize">Email <label class="fontset" style="margin-left: 132px;" >:  <?= $task['email']; ?></label></p>-->
											<!--<p class="text-capitalize" >State <label class="fontset" style="margin-left: 134px;" class="text-capitalize">: <?= $states['name']; ?></label></p>-->
											<!--<p class="text-capitalize">City <label class="fontset" style="margin-left: 142px;" class="text-capitalize">: <?= $cities['name']; ?></label></p>-->
											<!--<p class="text-capitalize">Phone Number <label class="fontset" style="margin-left: 72px;" class="text-capitalize">: <?= $task['phone_number']; ?></label></p>-->
											<!--<p class="text-capitalize">Address <label class="fontset" style="margin-left: 116px;" class="text-capitalize">: <?= $task['address']; ?></label></p>-->
											<!--<p>License </p>-->
