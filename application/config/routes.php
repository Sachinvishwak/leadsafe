...
//
$route['admin/group'] = 'company/Group/index';

$route['company/group/edit'] = 'company/Group/edit';



$route['admin/notification'] = 'company/Notification/index';

$route['company/notification/edit'] = 'company/Notification/edit';
