...
<html lang="en-us" id="extr-page">
  ...
  <body class="animated fadeInDown" data-base-url="<?php echo base_url(); ?>">
    ...
    <header id="header">
      <div id="logo-group">
        <span id="logo"> <img src="<?php echo $backend_assets; ?>img/logo.png" alt="<?= SITE_NAME; ?>"> LEAD-SAFE </span>
      </div>
        ...
        <div class="well no-padding">
          <form action="crewreset" id="crew-resetpassword-form" class="smart-form client-form">
            <header>Successful Verification</header>
              <fieldset>
               <section>
                <label class="label" style="font-family:'Courier New';font-size:15px" ></label>
                <label class="input"> 
                 <blockquote class="blockquote text-center" style="font-family:'Courier New';font-size:19px">
                 <p hidden class="mb-0"><?php echo 'Success:'; ?></p>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td style="color: green;">
                                                            Your Password Create Successfully.
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
