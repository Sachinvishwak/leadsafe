...
<html lang="en-us">
  ...
  -->
  <body class="" data-base-url="<?php echo base_url(); ?>" data-auth-url="">
    <!-- #preloader -->
    ...
    <header id="header">
      <div id="logo-group">
        ...
        <span id="logo"> <img src="<?php echo $backend_assets; ?>img/logo.png" alt="LEAD-SAFE"> LEAD-SAFE </span>
      ...
      <nav>
        ...
        <ul>
          ...
          <li class="<?php echo (strtolower($this->router->fetch_class()) == "dashboard") ? "active" : "" ?>">
            <a href="<?php echo base_url('contractor/dashboard'); ?>" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Dashboard</span></a>
          </li>
          
          <li class="<?php echo (strtolower($this->router->fetch_class()) == "project") ? "active" : "" ?>">
            <a href="<?php echo base_url('contractor/profile'); ?>" title="Project"><i class="fa fa-lg fa-fw fa-book"></i> <span class="menu-item-parent">Profile</span></a>
