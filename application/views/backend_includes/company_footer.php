<?php $backend_assets =  base_url().'backend_assets/';?>
  ...
  <!-- END MAIN CONTENT -->
    ...
    <div id="shortcut">
      <ul>
       <!--  <li>
        ...
        <li>
          <a href="<?php echo base_url('admin/profile');  ?>" class="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>My Profile </span> </span> </a>
        </li>  
      </ul>
    </div>
    <!-- END SHORTCUT AREA -->
    ...
    <!-- tagsinput -->
    <script src="<?php echo $backend_assets ?>plugins/tagsinput/tagsinput.js"></script>
