                ...
                <table width="100%" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">You have recently added by Bild It admin on Bild It app.  Please click on "Accept" button to complete your enrollment: </p>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">If you have already accepted this before, then please ignore this message.</p>  
