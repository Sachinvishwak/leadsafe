                ...
                <table width="100%" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">Bild It <?php echo $sender_type; ?> have invited you to join <?php echo $title; ?>. Please click on "Accept" button below to join: </p>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">If you have already added for this <?php echo $is_role; ?>, then please ignore this message.</p>  
